...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:function name="xml2tex:lang-to-babel-lang" as="xs:string?">
    ...
    <xsl:value-of select="     if($lang = ('af', 'nl')) then 'dutch'
                          else if($lang eq 'bg') then 'bulgarian'
                          else if($lang eq 'ca') then 'catalan'
                          else if($lang eq 'cs') then 'czech'
                          else if($lang eq 'cy') then 'welsh'
                          else if($lang eq 'da') then 'danish'
                          ...
                          else if($lang eq 'et') then 'estonian'
                          else if($lang eq 'eu') then 'basque'
                          else if($lang eq 'fi') then 'finnish'
                          else if($lang eq 'fr') then 'french'
                          else if($lang eq 'ga') then 'irish'
                          else if($lang eq 'gd') then 'scottish'
                          else if($lang eq 'gl') then 'galician'
                          else if($lang eq 'he') then 'hebrew'
                          else if($lang eq 'hr') then 'croatian'
                          else if($lang eq 'hu') then 'magyar'
                          else if($lang = ('id', 'ms')) then 'bahasa'
                          else if($lang = ('is', 'fo')) then 'icelandic'
                          else if($lang eq 'it') then 'italian'
                          else if($lang eq 'la') then 'latin'
                          else if($lang eq 'no') then 'norsk'
                          else if($lang eq 'is') then 'icelandic'
                          else if($lang eq 'pl') then 'polish'
                          else if($lang eq 'pt') then 'portuguese'
                          else if($lang eq 'ru') then 'russian'
                          else if($lang eq 'ro') then 'romanian'
                          else if($lang eq 'se') then 'samin'
                          else if($lang eq 'sl') then 'slovene'
                          else if($lang = ('sr', 'bs', 'hr', 'sr')) then 'serbian'
                          else if($lang eq 'sk') then 'slovak'
                          else if($lang eq 'sv') then 'swedish'
                          else if($lang eq 'tr') then 'turkish'
                          else if($lang eq 'uk') then 'ukrainian'
                          else ()"/>
  </xsl:function>
